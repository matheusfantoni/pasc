...
class Lexer():
    ...
    def contaErroLexico(self, contaErro):

        if(contaErro > 3):
            print("Limite de erros léxicos excedidos.")
            exit()
        else:
            contaErro += 1
            print("[Quantidade de Erros Detectados]: ", contaErro)
    ...
    def proxToken(self):
        ...
        while(True):
            ...
            variavelBooleana = re.match(r'[\x00-\x7F]+', c)
            #contaErro = 0
            ...
            if(estado == 1):
                ...
                if(c == ''):
                    ...
                    #contaErro += 1
                    # self.contaErroLexico(contaErro)
                    estado = 1
            elif(estado == 2):
